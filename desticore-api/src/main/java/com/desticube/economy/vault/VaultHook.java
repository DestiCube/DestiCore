package com.desticube.economy.vault;
...
public class VaultHook extends AbstractEconomy {
	    ...
	    public String currencyNamePlural() {
	        return EconomyHandler.a().getCurrency(2);
	    }

	    @Override
	    public String currencyNameSingular() {
	        return EconomyHandler.a().getCurrency(1);
	    }
	    ...
	    public String format(double balance) {
	        return EconomyHandler.a().formatCurrency(balance);
	    }
	    ...
	    public boolean createPlayerAccount(OfflinePlayer player) {
	        return EconomyHandler.a().getAccounts().createAccount(player);
	    }
	    ...
	    public double getBalance(OfflinePlayer player) {
	        return EconomyHandler.a().getAccounts().getAccount(player).getBalance();
	    }
	    ...
	    public boolean has(OfflinePlayer player, double amount) {
	        return EconomyHandler.a().getAccounts().getAccount(player).getBalance() >= amount;
	    }
	    ...
	    public boolean hasAccount(OfflinePlayer player) {
	        return EconomyHandler.a().getAccounts().hasAccount(player);
	    }
